...
%-------------------------------------------------------
\begin{frame}[fragile]\frametitle{Exercício 3 (1/2)}
Conte o número de operações executadas pelas seguintes funções.
\begin{enumerate}[a]
	\item {\scriptsize\lstinputlisting{src/exercicio03a.c}}
	\item {\scriptsize\lstinputlisting{src/exercicio03b.c}}
\end{enumerate}
\end{frame}

%-------------------------------------------------------
\begin{frame}[fragile]\frametitle{Exercício 3 (2/2)}
\begin{columns}[T]
\begin{column}{0.45\linewidth}
\begin{enumerate}[a]
	\setcounter{enumi}{2}
	\item {\scriptsize\lstinputlisting{src/exercicio03c.c}}
	\item {\scriptsize\lstinputlisting{src/exercicio03d.c}}
\end{enumerate}
\end{column}
\begin{column}{0.55\linewidth}
\begin{enumerate}[a]
	\setcounter{enumi}{4}
	\item {\scriptsize\lstinputlisting{src/exercicio03e.c}}
	\item {\scriptsize\lstinputlisting{src/exercicio03f.c}}
\end{enumerate}
\end{column}
\end{columns}
\end{frame}
...
%-------------------------------------------------------
\begin{frame}\frametitle{Exercício 4}
...
%-------------------------------------------------------
\begin{frame}[fragile]\frametitle{Exercício 5 (1/2)}
...
\begin{column}{0.5\linewidth}
\begin{enumerate}[a]
	\item {\scriptsize\lstinputlisting{src/exercicio05a.c}}
\vspace{-4mm}
	\item {\scriptsize\lstinputlisting{src/exercicio05b.c}}
\end{enumerate}
\end{column}
\begin{column}{0.5\linewidth}
\begin{enumerate}[a]
	\setcounter{enumi}{2}
	\item {\scriptsize\lstinputlisting{src/exercicio05c.c}}
\vspace{-4mm}
	\item {\scriptsize\lstinputlisting{src/exercicio05d.c}}
\end{enumerate}
	\end{column}
\end{columns}
\end{frame}
...
%-------------------------------------------------------
\begin{frame}[fragile]\frametitle{Exercício 5 (2/2)}
\begin{columns}[T]
\begin{column}{0.5\linewidth}
\begin{enumerate}[a]
	\setcounter{enumi}{4}
	\item {\scriptsize\lstinputlisting{src/exercicio05e.c}}
	\item {\scriptsize\lstinputlisting{src/exercicio05f.c}}
\end{enumerate}
\end{column}
\begin{column}{0.5\linewidth}
\end{column}
...
%-------------------------------------------------------
\begin{frame}\frametitle{Exercício 6}
...
%-------------------------------------------------------
\begin{frame}[fragile]\frametitle{Exercício 7} % Fonte: https://create.kahoot.it/details/2e37a282-4d9d-4902-8afc-9b827ed393fc
...
%-------------------------------------------------------
\begin{frame}[fragile]\frametitle{Exercício 8} % Fonte: https://create.kahoot.it/details/2e37a282-4d9d-4902-8afc-9b827ed393fc
Qual a complexidade do algoritmo abaixo?
{\scriptsize
\begin{verbatim}
...
%-------------------------------------------------------
\begin{frame}[fragile]\frametitle{Exercício 9} % Fonte: P1 (2023/1) - Iaçanã Ianiski Weber
...
%-------------------------------------------------------
\begin{frame}[fragile]\frametitle{Exercício 10} % Fonte: P1 (2023/1) - Iaçanã Ianiski Weber
...
%-------------------------------------------------------
\begin{frame}[fragile]\frametitle{Exercício 11} % Fonte: P1 (2023/1) - Iaçanã Ianiski Weber
Qual a notação $O$ dos algoritmos que têm as seguintes taxas de crescimento assintóticas?
\begin{enumerate}[a]
	\item $3n\log{n} + 2n + 5$      % $O(n\log{n})$
	\item $1000n\log{n} + 15n^3$    % $O(n^3)$
	\item $8\log{n} + n$            % $O(n)$
	\item $500n^5 + 2^n$            % $O(2^n)$
	\item $10\log{n} + 1521$        % $O(\log{n})$
	\item $3n + 4500n$              % $O(n)$
	\item $3n + 753\log{n} + 4$     % $O(n)$
\end{enumerate}
	\end{frame}
...
%-------------------------------------------------------
\begin{frame}[fragile]\frametitle{Exercício 1: \emph{Bubble Sort} (primeira implementação)}
{\scriptsize\lstinputlisting{bubble_sort/bubble_sort1.c}}
\end{frame}

%-------------------------------------------------------
\begin{frame}[fragile]\frametitle{Exercício 1: \emph{Bubble Sort} (gráfico da primeira implementação)}
\vspace{-5mm}
\begin{columns}[T]
\begin{column}{0.6\linewidth}
\begin{figure}[h]
...
%-------------------------------------------------------
\begin{frame}[fragile]\frametitle{Exercício 2: \emph{Bubble Sort} otimizado (comandos do \texttt{gnuplot})}
\begin{verbatim}
set xlabel "n" font "Arial,16"
set ylabel "t(us)" font "Arial,16"
...
%-------------------------------------------------------
\begin{frame}[fragile]\frametitle{Exercício 2: \emph{Bubble Sort} (gráfico das duas implementações)}
\vspace{-5mm}
\begin{columns}[T]
\begin{column}{0.6\linewidth}
\begin{figure}[h]
...
\begin{figure}[h]
	\centering
		\includegraphics[height=0.5\paperheight]{src/exercicio03a.jpg}
\end{figure}
{\fontsize{0}{4}\selectfont{}\textbf{GNUPLOT:}
\verbatiminput{src/exercicio03a.gnuplot}
}
\end{column}
\end{columns}
\end{frame}
...
\begin{figure}[h]
	\centering
	\includegraphics[height=0.5\paperheight]{src/exercicio03b.jpg}
\end{figure}
{\fontsize{0}{4}\selectfont{}\textbf{GNUPLOT:}
\verbatiminput{src/exercicio03b.gnuplot}
}
\end{column}
\end{columns}
\end{frame}
...
\begin{figure}[h]
	\centering
	\includegraphics[height=0.5\paperheight]{src/exercicio03c.jpg}
\end{figure}
{\fontsize{0}{4}\selectfont{}\textbf{GNUPLOT:}
\verbatiminput{src/exercicio03c.gnuplot}
}
\end{column}
\end{columns}
\end{frame}
...
\begin{figure}[h]
	\centering
	\includegraphics[height=0.5\paperheight]{src/exercicio03d.jpg}
\end{figure}
{\fontsize{0}{4}\selectfont{}\textbf{GNUPLOT:}
\verbatiminput{src/exercicio03d.gnuplot}
}
\end{column}
\end{columns}
\end{frame}
...
\begin{figure}[h]
	\centering
	\includegraphics[height=0.5\paperheight]{src/exercicio03e.jpg}
\end{figure}
{\fontsize{0}{4}\selectfont{}\textbf{GNUPLOT:}
\verbatiminput{src/exercicio03e.gnuplot}
}
\end{column}
\end{columns}
\end{frame}
...
\begin{figure}[h]
	\centering
	\includegraphics[height=0.5\paperheight]{src/exercicio03f.jpg}
\end{figure}
{\fontsize{0}{4}\selectfont{}\textbf{GNUPLOT:}
\verbatiminput{src/exercicio03f.gnuplot}
}
\end{column}
\end{columns}
\end{frame}
...
\begin{figure}[h]
	\centering
		\includegraphics[height=0.5\paperheight]{src/exercicio05a.jpg}
\end{figure}
{\fontsize{0}{4}\selectfont{}\textbf{GNUPLOT:}
\verbatiminput{src/exercicio05a.gnuplot}
}
\end{column}
\end{columns}
\end{frame}
...
\begin{figure}[h]
	\centering
		\includegraphics[height=0.5\paperheight]{src/exercicio05b.jpg}
\end{figure}
{\fontsize{0}{4}\selectfont{}\textbf{GNUPLOT:}
\verbatiminput{src/exercicio05b.gnuplot}
}
\end{column}
\end{columns}
\end{frame}
...
\begin{figure}[h]
	\centering
		\includegraphics[height=0.5\paperheight]{src/exercicio05c.jpg}
\end{figure}
{\fontsize{0}{4}\selectfont{}\textbf{GNUPLOT:}
\verbatiminput{src/exercicio05c.gnuplot}
}
\end{column}
\end{columns}
\end{frame}
...
\begin{figure}[h]
	\centering
		\includegraphics[height=0.5\paperheight]{src/exercicio05d.jpg}
\end{figure}
{\fontsize{0}{4}\selectfont{}\textbf{GNUPLOT:}
\verbatiminput{src/exercicio05d.gnuplot}
}
\end{column}
\end{columns}
\end{frame}
...
\begin{figure}[h]
	\centering
		\includegraphics[height=0.5\paperheight]{src/exercicio05e.jpg}
\end{figure}
{\fontsize{0}{4}\selectfont{}\textbf{GNUPLOT:}
\verbatiminput{src/exercicio05e.gnuplot}
}
\end{column}
\end{columns}
\end{frame}
...
\begin{figure}[h]
	\centering
		\includegraphics[height=0.5\paperheight]{src/exercicio05f.jpg}
\end{figure}
{\fontsize{0}{4}\selectfont{}\textbf{GNUPLOT:}
\verbatiminput{src/exercicio05f.gnuplot}
}
\end{column}
\end{columns}
\end{frame}
...
\begin{enumerate}[a]
	\setcounter{enumi}{0}
	\item \textbf{Algoritmo I:} $O(n^2)$ (quadrático)
	\item \textbf{Algoritmo II:} $O(\log{n})$
	\item \textbf{Algoritmo III:} $O(n^3)$ (cúbico)
	\item \textbf{Algoritmo IV:} $O(n^2)$ (quadrático)
	\item \textbf{Algoritmo V:} $O(1)$ (constante)
\end{enumerate}
\end{frame}
...
\begin{enumerate}[a]
	\setcounter{enumi}{0}
	\item $3n\log{n} + 2n + 5$ é $O(n\log{n})$
	\item $1000n\log{n} + 15n^3$ é $O(n^3)$
	\item $8\log{n} + n$ é $O(n)$
	\item $500n^5 + 2^n$ é $O(2^n)$
	\item $10\log{n} + 1521$ é $O(\log{n})$
	\item $3n + 4500n$ é $O(n)$
	\item $3n + 753\log{n} + 4$ é $O(n)$
\end{enumerate}
\end{frame}
