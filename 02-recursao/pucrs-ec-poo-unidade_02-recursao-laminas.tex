...
\begin{itemize}
	\item Iterativo
{\scriptsize\lstinputlisting{src/contagem.c}}
	\pause
	\item Recursivo
{\scriptsize\lstinputlisting{src/contagemRec.c}}
\end{itemize}
\end{frame}
...
\begin{itemize}
	\item Iterativo
{\scriptsize\lstinputlisting{src/contagemRegressiva.c}}
	\pause
	\item Recursivo
{\scriptsize\lstinputlisting{src/contagemRegressivaRec.c}}
\end{itemize}
\end{frame}
...
\begin{itemize}
	\item Iterativo
{\scriptsize\lstinputlisting{src/pesquisaLinear.c}}
	\pause
	\item Recursivo
{\scriptsize\lstinputlisting{src/pesquisaLinearRec.c}}
\end{itemize}
\end{frame}
...
\lstinputlisting[basicstyle=\ttfamily\scriptsize]{src/pesquisaBinaria.c}
\end{frame}
...
\lstinputlisting[basicstyle=\ttfamily\scriptsize]{src/pesquisaBinariaRec.c}
\end{frame}
...
\lstinputlisting[basicstyle=\ttfamily\tiny]{src/somatorio.c}
\end{enumerate}
\end{frame}
