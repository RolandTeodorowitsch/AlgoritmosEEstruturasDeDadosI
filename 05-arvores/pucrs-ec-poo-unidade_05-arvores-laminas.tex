...
\begin{figure}[h]
	\centering
	\includegraphics[height=0.4\paperheight]{imagens/arvore_a-enc.eps}
\end{figure}
\end{column}
\end{columns}
\end{itemize}
...
Árvore Binária
◼
 Uma árvore binária é aquela na qual o grau de cada
nodo é menor ou igual a 2
◼
 As subárvores de um nodo
A
são chamadas de
◼
...
Árvore Binária
◼
 Se o grau de um nodo é 1, deve-se especificar
se a sua subárvore é a da esquerda ou a da
direita
B
A
A
...
Árvore Binária
◼
 Uma árvore binária é própria se cada um de
seus nodos internos tiver dois filhos
◼
...
◼
 Quando se quer representar as diferentes saídas que
podem resultar a partir das respostas a um conjunto de
...
sim
 não
Conta Poupança
 Você vai necessitar do dinheiro
nos próximos 5 anos
sim
não
Fundo Préfixado
...
◼
 Também se pode usar referência para o nodo pai
...
Árvore Binária
◼
 Uma árvore qualquer pode ser transformada em
árvore binária
◼
 Fases para a transformação
1.
 Ligar os nodos irmãos
2.
 Desligar o nodo pai com os filhos,
...
E
 ...
 Irmão
seguinte
Mesmo nível → p/ direita
 F G
 Primeiro
Nível maior → p/ esquerda
 filho
Roteiro
