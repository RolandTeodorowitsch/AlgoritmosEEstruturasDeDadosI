...
Para que duas pilhas sejam consideradas iguais, elas devem ter o mesmo número de elementos nas mesmas posições nas duas pilhas; no entanto, o tamanho máximo das pilhas NÃO precisa ser igual. No retorno da função, o conteúdo das pilhas deve ser o mesmo da chamada.\\
}
\end{enumerate}
\end{frame}
