...
\hline
\multicolumn{1}{|C|}{5} & \multicolumn{1}{|C|}{7} & \multicolumn{1}{|C|}{8} & \multicolumn{1}{|C|}{1} & \multicolumn{1}{|C|}{3}\\
\hline
\end{tabular}
\end{center}
...
\lstinputlisting{src/lista_simplesmente_encadeada.cpp}
}
\end{frame}
...
\fontsize{5pt}{5pt}\selectfont{
\lstinputlisting{src/lista_duplamente_encadeada.cpp}
}
\end{frame}
